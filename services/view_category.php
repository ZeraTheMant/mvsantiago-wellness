...
<head>
	...
	<script>
		const category_id ='<?php echo $_GET['category_id']; ?>';
...
<body>
	<div class="wrapper">
		...
		<div id="testimonials-cover">
			...
			<div id="testimonials-header">
				<h2 id="testimonials-header-text">SERVICES LIST</h2>
				<p id="testimonials-subtitle">Select a service for further information.</p>
			</div>
	...
	<script src="../js/frontend_services_under_category.js"></script>
