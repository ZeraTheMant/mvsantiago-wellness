...
<head>
	...
	<title>Testimonials | M.V. Santiago Wellness Center</title>
</head>
<body>
	<div class="wrapper">
		<?php
		...
		<div id="testimonials-cover">
			<div id="testimonials-header">
				<h2 id="testimonials-header-text">TESTIMONIALS</h2>
				<p id="testimonials-subtitle">See what our patients say about us</p>
			</div>
			...
			<?php
				if(isset($_SESSION['client_id']) && $_SESSION['user_level'] != ""){
					echo '
						<button id="add-testimonial" class="frontend-btn" type="button">Share your experience with us!</button>
					';
				}
			?>
		</div>
	...
	<script>
		...
		document.querySelector('#header-testimonials').style.color = "green";
	</script>
