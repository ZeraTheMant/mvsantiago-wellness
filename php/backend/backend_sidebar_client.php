	...
	<div class="backend-sidebar">
		...
		<div class="links-container">
			<div class="header-link">
				<a href="backend_user_dashboard.php" id="dashboard-home-link" class="backend-sidebar-link"><span class="icon-meter generic-icon"></span> &nbsp;&nbsp;Dashboard Home</a>
			</div>
					
			<div class="header-link">
				<a href="backend_user_appointments.php" id="dashboard-appointments-link" class="backend-sidebar-link"><span class="icon-calendar generic-icon"></span> &nbsp;&nbsp;Appointments</a>
			</div>
			
			<!--<div class="header-link">
				<a href="backend_client_categories_services.php" id="dashboard-categories-link" class="backend-sidebar-link"><span class="icon-settings-for-categories generic-icon"></span> &nbsp;&nbsp;My Services</a>
			</div>-->
